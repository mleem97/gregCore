...
## 2026-05-21 - Unimplemented Network Broadcast TODO Removal
**Learning:** Found an unimplemented network broadcast for `RackPositionFreed` where the RPC call was commented out as a TODO. This causes missing network state synchronization for clients.
**Action:** Always ensure network RPC methods are fully implemented and uncommented for synchronization when creating NetworkBehaviours.
