# AGENTS.md — Hinweise für KI-Agenten (gregCore)

Repo: [https://github.com/mleem97/gregCore](https://github.com/mleem97/gregCore) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
