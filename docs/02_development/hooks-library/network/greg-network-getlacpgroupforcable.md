...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.NETWORK.GetLACPGroupForCable", |payload| {
...
~~~lua
greg.hook.after("greg.NETWORK.GetLACPGroupForCable", function(ctx)
...
gregBus.on("greg.NETWORK.GetLACPGroupForCable", (payload) => {
