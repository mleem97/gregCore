...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.NETWORK.Method_Internal_Static_Void_IntPtr_IntPtr_PDM_0", |payload| {
...
~~~lua
greg.on("greg.NETWORK.Method_Internal_Static_Void_IntPtr_IntPtr_PDM_0", function(payload)
...
~~~lua
greg.hook.after("greg.NETWORK.Method_Internal_Static_Void_IntPtr_IntPtr_PDM_0", function(ctx)
...
gregBus.on("greg.NETWORK.Method_Internal_Static_Void_IntPtr_IntPtr_PDM_0", (payload) => {
