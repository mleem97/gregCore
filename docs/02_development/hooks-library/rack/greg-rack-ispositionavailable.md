...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.RACK.IsPositionAvailable", |payload| {
...
~~~lua
greg.hook.after("greg.RACK.IsPositionAvailable", function(ctx)
...
gregBus.on("greg.RACK.IsPositionAvailable", (payload) => {
