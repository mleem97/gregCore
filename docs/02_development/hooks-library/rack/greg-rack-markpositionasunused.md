...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.RACK.MarkPositionAsUnused", |payload| {
...
~~~lua
greg.hook.after("greg.RACK.MarkPositionAsUnused", function(ctx)
...
gregBus.on("greg.RACK.MarkPositionAsUnused", (payload) => {
