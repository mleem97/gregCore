...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.SERVER.ButtonClickChangeIP", |payload| {
...
~~~lua
greg.hook.after("greg.SERVER.ButtonClickChangeIP", function(ctx)
...
gregBus.on("greg.SERVER.ButtonClickChangeIP", (payload) => {
