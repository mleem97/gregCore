...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.SYSTEM.ButtonCancelBuyWall", |payload| {
...
~~~lua
greg.hook.after("greg.SYSTEM.ButtonCancelBuyWall", function(ctx)
...
gregBus.on("greg.SYSTEM.ButtonCancelBuyWall", (payload) => {
