...
sidebar_label: greg.SYSTEM.CloseShop
...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.SYSTEM.CloseShop", |payload| {
...
~~~lua
greg.hook.after("greg.SYSTEM.CloseShop", function(ctx)
...
gregBus.on("greg.SYSTEM.CloseShop", (payload) => {
