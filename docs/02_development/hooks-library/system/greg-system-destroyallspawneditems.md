...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.SYSTEM.DestroyAllSpawnedItems", |payload| {
...
~~~lua
greg.hook.after("greg.SYSTEM.DestroyAllSpawnedItems", function(ctx)
...
gregBus.on("greg.SYSTEM.DestroyAllSpawnedItems", (payload) => {
