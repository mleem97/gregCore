...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.SYSTEM.SelectNextAvailable", |payload| {
...
~~~lua
greg.hook.after("greg.SYSTEM.SelectNextAvailable", function(ctx)
...
gregBus.on("greg.SYSTEM.SelectNextAvailable", (payload) => {
