...
fn register_hooks(bus: &mut EventBus) {
    bus.on("greg.SYSTEM.ValidateRackPosition", |payload| {
...
~~~lua
greg.hook.after("greg.SYSTEM.ValidateRackPosition", function(ctx)
...
gregBus.on("greg.SYSTEM.ValidateRackPosition", (payload) => {
