...
public sealed class gregLanguageBridgeHost
{
    ...
    public LuaLanguageBridge LuaBridge { get; }

    public gregLanguageBridgeHost(MelonLogger.Instance logger, string rustModsPath, gregFfiBridge gregFfiBridge)
    {
        _logger = logger;
        ...
        LuaBridge = new LuaLanguageBridge(_logger, luaRoot);
        _bridges.Add(LuaBridge);
        _bridges.Add(new TypeScriptJavaScriptLanguageBridge(_logger, jsTsRoot));
        _bridges.Add(new RustLanguageBridgeAdapter(_logger, rustModsPath, gregFfiBridge));
    }
