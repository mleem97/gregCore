...
#pragma warning restore CS0414
    ...
    private static void SetPortrait(Transform card, string employeeId)
    {
        try
        {
            ...
            // [Security] Prevent path traversal bypasses during direct method calls or deserialization
            ...
            {
                CrashLog.Log($"[Security] CustomEmployee: Invalid characters in employeeId={employeeId}");
            }
