...
public class LuaHotReload : IDisposable
{
    ...
    private string? FindModForFile(string filePath)
    {
        ...
        string rootPathWithSep = rootPath.EndsWith(Path.DirectorySeparatorChar.ToString())
            ? rootPath
            : rootPath + Path.DirectorySeparatorChar;

        bool isSafe = fullPath.Equals(rootPath, StringComparison.OrdinalIgnoreCase) ||
                      fullPath.StartsWith(rootPathWithSep, StringComparison.OrdinalIgnoreCase);
