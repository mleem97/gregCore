...
public static class GregIoLuaModule
{
    ...
    private static string ResolveSafe(string dataDir, string relativePath)
    {
        ...
        string dataDirFullWithSep = dataDirFull.EndsWith(separator) ? dataDirFull : dataDirFull + separator;

        bool isSafe = fullPath.Equals(dataDirFull, StringComparison.OrdinalIgnoreCase) ||
                      fullPath.StartsWith(dataDirFullWithSep, StringComparison.OrdinalIgnoreCase);
