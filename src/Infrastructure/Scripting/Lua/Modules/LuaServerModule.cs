...
public static class LuaServerModule
{
    public static void Register(Table greg, Script script, string modId)
    {
        ...
        // Bolt: Optimized to use O(1) NetworkMap dictionary instead of O(N) FindObjectsOfType
        ...
        // Bolt: Optimized to use O(1) NetworkMap.brokenServers instead of O(N) FindObjectsOfType
        ...
        serverTable["repair_all"] = (Func<int>)(() =>
        {
            try
            {
                ...
                if (nm != null && nm.brokenServers != null)
                {
                    ...
                    foreach (var kvp in nm.brokenServers) toRepair.Add(kvp.Value);
