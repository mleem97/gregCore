...
namespace greg.QoL
{
    public class Main : MelonMod
    {
        ...
        private void RegisterSettings()
        {
            ...
            gregCore.API.GregAPI.Settings.RegisterSlider(modId, "trash_cleaner_spool_threshold", "Cable Spool Length Threshold", 0f, 10f, 1.5f, val => _cableSpoolLengthThreshold = val, new gregCore.API.GregSettingsProxy.SliderOptions { Cat = "QoL", Desc = "Max length of cable spools to consider as trash." });
        }
