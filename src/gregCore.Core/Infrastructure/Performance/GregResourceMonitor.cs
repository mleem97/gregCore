...
internal sealed class GregResourceMonitor : IDisposable
{
    ...
    {
        // Private Bytes statt WorkingSet: unter Proton/Wine ist WorkingSet
        // permanent ueber jeder Schwelle (Wine-Mapping) und wuerde alle 5s
        // Warnung + Gen1-GC ausloesen - sichtbarer FPS-Schaden ohne Nutzen.
