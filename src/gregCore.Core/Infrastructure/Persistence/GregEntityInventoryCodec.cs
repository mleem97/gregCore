...
/// Zweck:        Dritte Haelfte von GregEntityInventory (partial): Config,
///               Sidecar-Serialisierung und reine Helfer (UID/Keys/TSV,
///               Display-Scrub). Getrennt wegen Codeline-Limits.
/// </file-summary>
