...
/// Zweck:        Zweite Haelfte von GregEntityInventory (partial): Sammeln
///               der Save-Eintraege pro Kind + UID-Aufloesung fuer Kinds ohne
///               stabilen Vanilla-Key. Getrennt wegen Codeline-Limits.
/// </file-summary>
