...
/// Purpose:     Attack escalation: malicious attacks get worse over time
///               (shorter intervals, higher spawn rate/speed per
///               tier). Reads vanilla base values, scales them per tier,
///               all best-effort. Pure managed tier math (testable).
/// </file-summary>
...
public static class GregAttackEscalation
{
    ...
    // ── Pure tier math (testable without the game) ─────────────────────────────
