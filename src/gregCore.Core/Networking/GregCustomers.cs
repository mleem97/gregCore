...
/// Zweck:        Customer-Brücke (Runtime): CustomerBase finden/lesen
///               (IDs, Money-Speed, Requirements, IP-Lookup, Routed-Subnets,
///               LoadData), CustomerItem lesen, CustomerCard befüllen.
///               Alles best-effort.
/// </file-summary>
...
public static class GregCustomers
{
        ...
        string routeKey, List<string> ips)
    {
        ...
        {
            Warn($"TryRegisterRoutedSubnet fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool TryUnregisterRoutedSubnet(global::Il2Cpp.CustomerBase cb, string routeKey)
    {
        ...
        {
            Warn($"TryUnregisterRoutedSubnet fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }

    // ── Save-Brücke (Vanilla-Pfad, DTO aus GregCustomerSaves) ────────────────
    ...
    public static bool LoadData(global::Il2Cpp.CustomerBase cb, GregCustomerSaves.CustomerBase dto)
    {
        ...
        {
            Warn($"LoadData fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool SetCardCustomer(global::Il2Cpp.CustomerCard card, global::Il2Cpp.CustomerItem item)
    {
        ...
        {
            Warn($"SetCustomer fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
