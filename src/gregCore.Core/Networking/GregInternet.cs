...
/// Purpose:     Internet and service bridge: read/maintain internet endpoints,
///               CommandCenter (level, auto-repair, upgrades),
///               attack manager (permission, start). All best-effort.
/// </file-summary>
...
public static class GregInternet
{
    ...
    public static bool SetAutoRepairMode(int mode)
    {
        ...
        {
            Warn($"SetAutoRepairMode failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool ToggleAutoClearWarnings(bool isOn)
    {
        ...
        {
            Warn($"ToggleClearWarningAuto failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool UpgradeCommandCenter()
    {
        ...
        {
            Warn($"ButtonUpgradeCommandCenter failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool DowngradeCommandCenter()
    {
        ...
        {
            Warn($"ButtonDowngradeCommandCenter failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool LaunchAttack()
    {
        ...
        {
            Warn($"LaunchAttack failed: {Base(ex)}");
            return false;
        }
    }
    ...
    private static void Try(Action action)
    {
        ...
        {
            try { MelonLogger.Warning($"[gregCore][Net] Internet field failed: {ex.GetBaseException().Message}"); } catch { /* ignored: defensive best-effort (CONVENTIONS.md) */ }
        }
    }
}
