...
/// Purpose:     Second part of GregNetworkDeviceSaves (partial):
///               create/fill/read/upsert logic. Split due to codeline limits.
/// </file-summary>
...
public static partial class GregNetworkDeviceSaves
{
    ...
    private static void Try(Action action)
    {
        ...
        {
            try { MelonLogger.Warning($"[gregCore][Net] DeviceSaves field failed: {ex.GetBaseException().Message}"); } catch { /* ignored: defensive best-effort (CONVENTIONS.md) */ }
        }
    }
}
