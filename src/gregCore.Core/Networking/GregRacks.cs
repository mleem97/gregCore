...
/// Purpose:     Rack + trolley bridge: find racks, check/
///               mark positions, RackPosition by UID, trolley bays, wall check,
///               CarryModelPool, trolley handles. All best-effort.
/// </file-summary>
...
public static class GregRacks
{
    ...
    public static bool MarkPosition(global::Il2Cpp.Rack rack, int index, int sizeInU, bool used)
    {
        ...
        {
            Warn($"MarkPosition failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool UnmountRack(global::Il2Cpp.Rack rack)
    {
        ...
        {
            Warn($"UnmountRack failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool InitializeLoadedRack(global::Il2Cpp.Rack rack, int[] loadedPositions)
    {
        ...
        {
            Warn($"InitializeLoadedRack failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool BeginInsertItem(global::Il2Cpp.RackPosition pos)
    {
        ...
        {
            Warn($"InsertItemInRack failed: {Base(ex)}");
            return false;
        }
    }

    // ── Trolley bays / handles / wall check ──────────────────────────────────
    ...
    public static bool FreeTrolleySlot(global::Il2Cpp.TrolleyLoadingBay bay, int startIdx, int sizeInU)
    {
        ...
        {
            Warn($"FreeTrolleySlot failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool ResetAllTrolleySlots(global::Il2Cpp.TrolleyLoadingBay bay)
    {
        ...
        {
            Warn($"ResetAllSlots failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool ClickTrolleyHandle(global::Il2Cpp.PushTrolleyHandle handle)
    {
        ...
        {
            Warn($"TrolleyHandle-Click failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool TriggerOverlapCheck(global::Il2Cpp.CheckIfTouchingWall check)
    {
        ...
        {
            Warn($"PerformOverlapCheck failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool SetWallCheckRenderers(global::Il2Cpp.CheckIfTouchingWall check, bool enabled)
    {
        ...
        {
            Warn($"SetRenderersEnabled failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool PoolReturn(GameObject obj, int prefabID)
    {
        ...
        {
            Warn($"Pool-Return failed: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool ClearPool()
    {
        ...
        {
            Warn($"Pool-Clear failed: {Base(ex)}");
            return false;
        }
    }
    ...
    private static void Try(Action action)
    {
        ...
        {
            try { MelonLogger.Warning($"[gregCore][Net] Racks field failed: {ex.GetBaseException().Message}"); } catch { /* ignored: defensive best-effort (CONVENTIONS.md) */ }
        }
    }
}
