...
/// Zweck:        Shop-Brücke: ScriptableObjects lesen (ShopItemSO), Runtime-
///               Items (ShopItem: Unlock/Buy), Warenkorb-Zeilen (ShopCartItem:
///               lesen, +/-), Mod-Items (ModShopItem) sowie der native
///               FlexibleColorPicker (öffnen, Farbe lesen/setzen, abbrechen).
///               Alles best-effort.
/// </file-summary>
...
public static class GregShop
{
    ...
    public static bool UnlockItem(global::Il2Cpp.ShopItem si)
    {
        ...
        {
            Warn($"UnlockButton fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool BuyItem(global::Il2Cpp.ShopItem si)
    {
        ...
        {
            Warn($"ButtonBuyItem fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }

    // ── ShopCartItem (Warenkorb-Zeilen) ──────────────────────────────────────
    ...
    public static bool CartAddOne(global::Il2Cpp.ShopCartItem ci)
    {
        ...
        {
            Warn($"Cart+ fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool BuyModItem(global::Il2Cpp.ModShopItem mi)
    {
        ...
        {
            Warn($"ModShopItem-Buy fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }

    // ── FlexibleColorPicker (nativ) ──────────────────────────────────────────
    // Ermöglicht Mods den Vanilla-Farbflow direkt (statt Handoff): Öffnen,
    // Farbe setzen/lesen, Abbrechen. Picker-GameObject gehört dem Shop.
    ...
    public static bool OpenPicker(global::Il2Cpp.ComputerShop shop)
    {
        ...
        {
            Warn($"OpenColorPicker fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool CancelPicker(global::Il2Cpp.ComputerShop shop)
    {
        ...
        {
            Warn($"ButtonCancelColorPicker fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool SetPickerColor(global::Il2Cpp.ComputerShop shop, Color color)
    {
        ...
        {
            Warn($"SetColor fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
