...
/// Zweck:        Vanilla-Tooltip-Brücke: Overlay-/World-Tooltips zeigen und
///               verstecken (für Mod-UIs), Interact-Tooltips ansteuern.
///               Alles best-effort.
/// </file-summary>
...
public static class GregTooltips
{
    ...
    public static bool ShowOverlay(string text, Vector3 position, int xOffset)
    {
        ...
        {
            Warn($"ShowTooltipOverlayCanvas fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool ShowWorld(string text, RectTransform transform, Camera cam)
    {
        ...
        {
            Warn($"ShowTooltipWorldCanvas fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool Hide()
    {
        ...
        {
            Warn($"HideTooltip fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool ShowInteract(string text)
    {
        ...
        {
            Warn($"ShowTooltipForInteract fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
    ...
    public static bool HideInteract()
    {
        ...
        {
            Warn($"HideTooltipForInteract fehlgeschlagen: {Base(ex)}");
            return false;
        }
    }
