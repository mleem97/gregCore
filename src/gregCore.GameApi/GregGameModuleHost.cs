/// <file-summary>
/// Layer:       GameApi
/// Purpose:     Runtime helper for all generated game-type modules.
/// Maintainer:  Instance lookup and on-demand method hooks (Postfix only).
/// </file-summary>
...
public static class GregGameModuleHost
{
    ...
    public static void GameApiPostfix(MethodBase __originalMethod)
    {
        ...
        catch { /* Hooks must never break the game */ }
    }
}
