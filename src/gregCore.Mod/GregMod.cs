/// <file-summary>
/// Layer:       PublicApi
/// Purpose:     Base class for all gregCore mods.
/// Maintainer:  Does not inherit from MelonMod — registered and managed by gregCore.
/// </file-summary>
...
public abstract class GregMod
{
    ...
    public void Initialize(GregApiContext context)
    {
    ...
    public void DisposeResources() => Api.Resources?.Dispose();
}
