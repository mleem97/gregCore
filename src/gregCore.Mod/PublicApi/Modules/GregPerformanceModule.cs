...
public sealed class GregPerformanceModule
{
    ...
    // ── Profile Management ───────────────────────────────────────────────────
    // Default ist FPS-only (Safe). Grafik-Profile (Balanced/LowEnd/...) nur
    // explizit via UseProfile() — sie fassen Quality/LOD/Mipmaps/FarClip an.
    ...
    public void RestoreGameGraphics() => _governor.RestoreGameGraphics();
    ...
    public PerformanceProfile Safe => PerformanceProfile.Safe;
