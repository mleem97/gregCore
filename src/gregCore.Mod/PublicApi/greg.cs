...
public static class greg
{
    ...
    private static GregDemandModule? _demand;
    private static GregGameModule? _game;
    ...
    public static GregDemandModule Demand => _demand ??= new GregDemandModule(Context);
    public static GregGameModule Game => _game ??= new GregGameModule(Context);
