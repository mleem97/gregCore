...
namespace gregCore.UI
{
    ...
    public static class GregFontLoader
    {
        ...
        // UGUI-/Toolkit-Font fuer Mod-UIs (LegacyRuntime aus den Built-in
        // Resources bzw. Spiel-Font, sobald gefunden). Null bis SearchFonts
        // erfolgreich war - Aufrufer muessen null-tolerant sein.
