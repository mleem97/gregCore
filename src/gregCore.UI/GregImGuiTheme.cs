...
{
    /// <summary>
    /// Kanonisches IMGUI-Theme (Himmelblau/Atollblau, modern minimal).
    /// Gegenstück zu GregUITheme (UI Toolkit) für IMGUI-Mods.
    /// Dummy-sichere Factories (parameterlose Ctors + Feldzuweisung).
    /// Mod-lokale Mirrors (ModImGuiTheme.cs) sind Standalone-Fallbacks
    /// ohne DLL-Abhängigkeit und werden von hier aus synchron gehalten.
    /// </summary>
