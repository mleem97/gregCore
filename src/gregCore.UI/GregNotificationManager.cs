...
namespace gregCore.UI
{
    ...
    public static class GregNotificationManager
    {
        ...
        // Custom-Icon per Name aus dem IconToolkit (z.B. mod-eigene Icons).
        ...
        // Rich-Toast: optionales Cover/Thumbnail + bis zu drei Textzeilen
        // (z.B. Now-Playing: klein/gross/klein). Cover als Texture2D.
        ...
        private static void CreateToast(string message, float duration, string icon, Color accent)
        {
            ...
            // Toolkit-Default-Font ist im IL2CPP-Build unbrauchbar (Text
            // unsichtbar): Spiel-Font zuweisen sobald verfuegbar.
            try
            {
