...
public class GregSettingsPersistenceService
{
    ...
    public void Load()
    {
        try
        {
            _logger.Info("Loading settings and keybinds...");
            if (File.Exists(_keybindsFile))
            {
                ...
                if (entries != null)
                {
                    ...
                    _logger.Info($"[Settings] {entries.Count} keybinds loaded.");
                }
            }
        ...
        {
            _logger.Error("[Settings] Error loading Persistence.", ex);
        }
    }
    ...
    public void Save()
    {
        try
        {
            ...
            _logger.Info($"[Settings] {keybinds.Count} keybinds and {settings.Count} settings saved.");
        }
        catch (Exception ex)
        {
            _logger.Error("[Settings] Error saving Persistence.", ex);
        }
    }
