...
public static class gregApi
{
    ...
    /// <summary>
    /// Checks if the game gregCoreLoader systems are initialized and ready for API calls.
    /// </summary>
    ...
    {
        gregLocalisationBridge.RegisterResolver(resolverId, resolver);
    }
    ...
    {
        gregLocalisationBridge.UnregisterResolver(resolverId);
    }
