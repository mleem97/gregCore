...
/// Handles relay-based networking, remote player rendering, UI panel, and gregMain menu button injection.
/// </summary>
public class gregMultiplayerBridge
{
    ...
    public gregMultiplayerBridge(MelonLogger.Instance logger)
    {
        _logger = logger;
    ...
    // ═══════════════════════════════════════════════════════════════════════
    //  OnUpdate  (called every frame from gregCoreLoader.OnUpdate)
    // ═══════════════════════════════════════════════════════════════════════

    public void OnUpdate(float dt)
    {
        // --- Handle pending gregMain-menu button injection ---
        ...
        // --- gregMain update loop (only when initialized) ---
        try
        {
            HandleKeybinds();
        ...
        {
            CrashLog.LogException("gregMultiplayerBridge.OnUpdate", ex);
        }
    }
    ...
    // ═══════════════════════════════════════════════════════════════════════
    //  gregMain Menu Button Injection
    // ═══════════════════════════════════════════════════════════════════════
    ...
    private void InjectMainMenuButton()
    {
        try
        {
            ...
            _menuButton = clone;
            _logger.Msg("[MP Bridge] Multiplayer button injected into gregMain menu.");
        }
        catch (Exception ex)
        {
    ...
    /// <summary>
    /// Called from gregCoreLoader.OnGUI(). Draws the multiplayer panel if toggled on.
    /// </summary>
    public void DrawGUI()
    {
...
// ═══════════════════════════════════════════════════════════════════════════
//  BillboardNameTag — always faces the gregMain camera
// ═══════════════════════════════════════════════════════════════════════════
