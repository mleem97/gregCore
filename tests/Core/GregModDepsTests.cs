/// <file-summary>
/// Layer:       Tests
/// Purpose:     Tests for GregModDeps (versions, manifest diff) — purely
///               managed logic, runnable without the game.
/// </file-summary>
...
public class GregModDepsTests
{
    ...
    public void DiffManifests_Identical_IsCompatible()
    {
        ...
        GregModDeps.FormatDiff(diff).Should().Contain("compatible");
    }
