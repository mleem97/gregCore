...
- **Do not:** write into vanilla save structures directly, reuse shop/item IDs or GUIDs (see [Developer Shop Items](./developer-shop-items/)), hand-edit sidecars, or cache Il2Cpp objects long-term (GC moves them — see [Developer Harmony IL2CPP](./developer-harmony-il2cpp/)).
- Deep dives: [Developer Data Storage](./developer-data-storage/), [Developer Hardware IDs Inventory](./developer-hardware-ids-inventory/).
