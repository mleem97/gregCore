---
title: "Guidebook CSharp 04 Patches"
---
...
- Never cache Il2Cpp objects long-term (GC moves them); re-resolve via inventory UIDs ([Guidebook CSharp 05 Saves Shop](./guidebook-csharp-05-saves-shop/)).
...
Next: [Guidebook CSharp 05 Saves Shop](./guidebook-csharp-05-saves-shop/) — sidecars, inventory, shop items.
