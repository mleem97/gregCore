---
title: "Guidebook Lua 02 Events"
---
# Guidebook Lua 02 Events

React to the game and talk to other mods. Concepts: [Core Events](./core-events/). Full catalog: [Hooks Reference](./hooks-reference/).
...
3. If nothing fires: confirm `game_hooks.json` sits next to `gregCore.dll`, check `[DynamicPatcher]` log lines, then [FAQ Troubleshooting](./faq-troubleshooting/).
...
Next: [Guidebook Lua 03 Timers Storage](./guidebook-lua-03-timers-storage/) — scheduling plus settings, state, and files.
