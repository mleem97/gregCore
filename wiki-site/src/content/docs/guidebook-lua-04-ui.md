---
title: "Guidebook Lua 04 UI"
---
# Guidebook Lua 04 UI

Show things: toasts, log lines, tablets, widgets, and a settings tab. (C# panels: [Guidebook CSharp 03 UI](./guidebook-csharp-03-ui/).)
...
Next: [Guidebook Lua 05 Systems](./guidebook-lua-05-systems/) — the domain APIs (player, servers, shop, world).
