---
title: "Guidebook Modelling Shop Item"
---
...
- Item IDs from the high ranges (`100`, `1000/2000/3000`, `9001+`), never reused — saves reference them (see [Developer Shop Items](./developer-shop-items/)).
...
Next: [Guidebook Modelling Static Item](./guidebook-modelling-static-item/).
